(function() {
  ...
  */
  if( sum ) {
    number1 = 10;
    number2 = 12;
    console.log( showOperationMessage( operator, number1, number2 ), sum( number1, number2 ) );
  }
  else {
  ...
  */
  ...
  if( subtraction ) {
    number1 = 8;
    number2 = 11;
    console.log( showOperationMessage( operator, number1, number2 ), subtraction( number1, number2 ) );
  }
  else {
    console.log( showErrorMessage( operator ) );
  }
  ...
  if( multiplication ) {
    number1 = 80;
    number2 = 5;
    console.log( showOperationMessage( operator, number1, number2 ), multiplication( number1, number2 ) );
  }
  else {
    console.log( showErrorMessage( operator ) );
  }
  ...
  if( division ) {
    number1 = 150;
    number2 = 3;
    console.log( showOperationMessage( operator, number1, number2 ), division( number1, number2 ) );
  }
  else {
    console.log( showErrorMessage( operator ) );
  }
  ...
  if( mod ) {
    number1 = 150;
    number2 = 11;
    console.log( showOperationMessage( operator, number1, number2 ), mod( number1, number2 ) );
  }
  else {
    console.log( showErrorMessage( operator ) );
  }
  ...
  */
  ...
  if( invalid ) {
    number1 = 8;
    number2 = 11;
    console.log( showOperationMessage( operator, number1, number2 ), invalid( number1, number2 ) );
  }
  else {
    console.log( showErrorMessage( operator ) );
  }
