...
console.log( adicionarPessoas( 2 ) ); // Já temos 2 pessoas no carro!

// Adicione mais 4 pessoas no carro.
console.log( adicionarPessoas( 4 ) ); // Só cabem mais 3 pessoas!

// Faça o carro encher.
console.log( adicionarPessoas( 3 ) ); // Já temos 5 pessoas no carro!

// Tire 4 pessoas do carro.
console.log( adicionarPessoas(-4) ); // Já temos 1 pessoas no carro!
